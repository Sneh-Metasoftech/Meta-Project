...
<section>
            ...
            <div class="container-6  mtt mtl">
                ...
                <form  action="#"  method="post" class="p-1 wid" style="box-shadow: 0px 4px 7px 1px;border-radius: 10px; padding:15px!important;">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="category" placeholder="Enter the Blog Category">
                </div>    
