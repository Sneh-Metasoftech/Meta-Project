                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-9 col-lg-8">
                            ...
                            <div class="cta-content">
                                <div class="cta-icon">
                                    <img src="assets/images/cta-icon2.png" alt="" style="padding-top: 8px;">
                                </div>
                        ...
                        <div class="col-xl-3 col-lg-4">
                            <!-- Cta Button Start -->
                            <div class="cta-btn">
                                <a class="btn btn-white" href="#">07714919414</a>
                            </div>
                            <!-- Cta Button End -->
                        </div>
                    </div>
                                ...
                                <div class="widget-info">
                                    <ul>
                                        <li>
                                            ...
                                            <div class="info-text">
                                                <span><a href="#">07714919414</a></span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="info-icon">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright-text text-center">
                                    <p>© Copyrights 2024 The Meta Softech Pvt Ltd All rights reserved. </p>
                                </div>
