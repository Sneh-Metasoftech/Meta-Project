...
<div class="main-wrapper">
 ...
 <div class="section page-banner-section" style="background-image: url(assets/images/bg/ihhh.jpg);">
    ...
    <div class="container">
        <div class="sidebar">
        <ul>
                <li><a href="It-consultant.php" class="active">IT Consultancy</a></li>
                <li><a href="data-science.php">Data Science</a></li>
                <li><a href="security.php">IT Security</a></li>
                <li><a href="blockchain.php">Blockchain System</a></li>
                <li><a href="#">IT Infrustructure</a></li>
                <li><a href="infra.php">Data Managment</a></li>
                <li><a href="it-management.php">IT Managment</a></li>
                <li><a href="counsulatacy.php">IT Consultancy</a></li>
            </ul>
        </div>

        <div class="content">
            <h1>IT Infrustructure</h1>
            <p>An IT consultancy provides expert guidance to businesses in optimizing their technology strategies. Consultants assess current systems, identify inefficiencies, and offer tailored solutions for improvements. Services often include IT infrastructure design, cybersecurity, cloud migration, and software integration. Their goal is to enhance operational efficiency, reduce costs, and support digital transformation.</p>
            <ul>
                <li>Create and manage business logic independently from applications and processes.</li>
                <li>Make decisions with precision, targeting each customer interaction intelligently.</li>
                <li>Give businesses the agility and speed to meet changing demands.</li>
            </ul>
        </div>
