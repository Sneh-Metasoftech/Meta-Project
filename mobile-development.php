...
<style>
 <style>
    ...
    .sections {
      ...
      animation: slideInLeft 0.8s forwards; /* Slide in from left */
    }
    ...
    .sections img {
      ...
      opacity: 0;
      animation: zoomIn 2.0s forwards; /* Zoom-in effect for images */
      animation-delay: 0.3s; /* Delay for image zoom-in */
    }
    ...
    .services {
      ...
      animation: slideInRight 5.0s forwards; /* Slide in from right */
      animation-delay: 0.1s; /* Delay for animation to start */
    }

    .services:nth-child(odd) {
      animation-delay: 0.1s; /* Different delay for odd services */
    }
...
<body>
 ...
 <!-- Header End  -->
    ...
    <div class="sections">
      <img src="path-to-image1.png" alt="Mobile app interface">
      <p>Our apps feature sleek and intuitive designs, ensuring an exceptional user experience with smooth navigation and responsive features.</p>
    </div>

    <div class="sections">
      <img src="path-to-image2.png" alt="App architecture and coding">
      <p>We focus on high-performance code, cloud integration, and optimal architecture to bring your mobile app ideas to life.</p>
    </div>

    <h2 style="text-align: center; margin-top: 50px;">Our Services</h2>
    <div class="servicess">
      <div class="services">
        <h3>Custom App Development</h3>
        <p>We build custom applications tailored to your business needs, ensuring a perfect fit for your goals.</p>
      </div>
      <div class="services">
        <h3>UI/UX Design</h3>
        <p>Our design team creates engaging and user-friendly interfaces that enhance user satisfaction and retention.</p>
      </div>
      <div class="services">
        <h3>Maintenance & Support</h3>
        <p>We provide ongoing maintenance and support to ensure your app runs smoothly and stays updated with the latest technology.</p>
      </div>
      <div class="services">
        <h3>Consulting Services</h3>
        <p>Our experts guide you through the mobile app development process, from ideation to launch and beyond.</p>
      </div>
      <div class="services">
        <h3>Cross-Platform Development</h3>
        <p>We develop apps that work seamlessly across different platforms, maximizing your reach and impact.</p>
      </div>
      <div class="services">
        <h3>App Marketing</h3>
        <p>Our marketing strategies help you promote your app effectively, driving downloads and user engagement.</p>
      </div>
    </div>
  </div>
</section>
